...
const ambiguousCases: EvalTestCase[] = [
  { id: 'S5-AMB-001', query: 'spark plug for car engine ignition', source: 'session5-ambiguous', category: 'ambiguous', expected_routing: 'classify', expected_chapter: '85', alternative_chapters: ['87'], difficulty: 'medium', notes: 'Ch.85 (electrical ignition) or Ch.87 (vehicle parts)' },
  { id: 'S5-AMB-002', query: 'car windshield laminated safety glass', source: 'session5-ambiguous', category: 'ambiguous', expected_routing: 'classify', expected_chapter: '70', alternative_chapters: ['87'], difficulty: 'medium', notes: 'Ch.70 (safety glass) or Ch.87 (vehicle parts)' },
  { id: 'S5-AMB-003', query: 'rubber floor mat for car interior', source: 'session5-ambiguous', category: 'ambiguous', expected_routing: 'classify', expected_chapter: '40', alternative_chapters: ['87'], difficulty: 'medium', notes: 'Ch.40 (rubber articles) or Ch.87 (vehicle accessory)' },
  { id: 'S5-AMB-004', query: 'motorcycle helmet protective headgear', source: 'session5-ambiguous', category: 'ambiguous', expected_routing: 'classify', expected_chapter: '65', alternative_chapters: ['87'], difficulty: 'medium', notes: 'Ch.65 (headgear) or Ch.87 (vehicle accessory)' },
  { id: 'S5-AMB-005', query: 'car seat cover leather custom fit', source: 'session5-ambiguous', category: 'ambiguous', expected_routing: 'classify', expected_chapter: '42', alternative_chapters: ['87'], difficulty: 'medium', notes: 'Ch.42 (leather articles) or Ch.87 (vehicle accessory)' },
  { id: 'S5-AMB-006', query: 'vehicle headlight bulb halogen H4', source: 'session5-ambiguous', category: 'ambiguous', expected_routing: 'classify', expected_chapter: '85', alternative_chapters: ['87'], difficulty: 'medium', notes: 'Ch.85 (electric lamps) or Ch.87 (vehicle parts)' },
  { id: 'S5-AMB-007', query: 'silicone sealant tube for construction', source: 'session5-ambiguous', category: 'ambiguous', expected_routing: 'classify', expected_chapter: '32', alternative_chapters: ['39'], difficulty: 'medium', notes: 'Ch.32 (mastics/putty) or Ch.39 (silicone/plastic)' },
  { id: 'S5-AMB-008', query: 'foam mattress memory foam polyurethane', source: 'session5-ambiguous', category: 'ambiguous', expected_routing: 'classify', expected_chapter: '94', alternative_chapters: ['39'], difficulty: 'medium', notes: 'Ch.94 (mattresses) or Ch.39 (cellular plastic)' },
  ...
  { id: 'S5-AMB-010', query: 'sports bra lycra elastic womens fitness', source: 'session5-ambiguous', category: 'ambiguous', expected_routing: 'classify', expected_chapter: '61', alternative_chapters: ['62'], difficulty: 'medium', notes: 'Ch.61 (knitted) or Ch.62 (woven) - depends on construction' },
  { id: 'S5-AMB-011', query: 'canvas tote bag cotton shopping reusable', source: 'session5-ambiguous', category: 'ambiguous', expected_routing: 'classify', expected_chapter: '42', alternative_chapters: ['63'], difficulty: 'medium', notes: 'Ch.42 (bags) or Ch.63 (textile articles)' },
  ...
  { id: 'S5-AMB-013', query: 'power bank lithium portable charger 10000mAh', source: 'session5-ambiguous', category: 'ambiguous', expected_routing: 'classify', expected_chapter: '85', alternative_chapters: ['84'], difficulty: 'medium', notes: 'Ch.85 (accumulators) or Ch.84 (computer accessory)' },
  { id: 'S5-AMB-014', query: 'yoga mat PVC exercise fitness', source: 'session5-ambiguous', category: 'ambiguous', expected_routing: 'classify', expected_chapter: '95', alternative_chapters: ['39'], difficulty: 'medium', notes: 'Ch.95 (sports equipment) or Ch.39 (plastic sheet)' },
  { id: 'S5-AMB-015', query: 'drone with camera quadcopter aerial photography', source: 'session5-ambiguous', category: 'ambiguous', expected_routing: 'classify', expected_chapter: '88', alternative_chapters: ['85'], difficulty: 'hard', notes: 'Ch.88 (aircraft/UAV) or Ch.85 (electronic device)' },
];

// Session5 Automotive unique cases (not in comprehensive)
const automotiveSupplemental: EvalTestCase[] = [
  { id: 'S5-AUTO-002', query: 'brake drum cast iron for Tata truck rear axle', source: 'session5-automotive', category: 'automotive', expected_routing: 'classify', expected_chapter: '87', difficulty: 'medium', notes: 'GIR 2a: cast iron -> function (brake drum)' },
  { id: 'S5-AUTO-003', query: 'disc brake rotor ventilated for passenger car', source: 'session5-automotive', category: 'automotive', expected_routing: 'classify', expected_chapter: '87', difficulty: 'medium', notes: 'GIR 2a: steel rotor -> function (brakes)' },
  { id: 'S5-AUTO-005', query: 'piston rings chrome plated for diesel engine truck', source: 'session5-automotive', category: 'automotive', expected_routing: 'classify', expected_chapter: '87', difficulty: 'hard', notes: 'GIR 2a: metal rings -> function (engine parts)' },
  ...
  { id: 'S5-AUTO-012', query: 'coil spring suspension front for SUV', source: 'session5-automotive', category: 'automotive', expected_routing: 'classify', expected_chapter: '87', difficulty: 'medium', notes: 'GIR 2a: steel spring -> function (suspension)' },
  { id: 'S5-AUTO-014', query: 'steering rack assembly hydraulic for sedan', source: 'session5-automotive', category: 'automotive', expected_routing: 'classify', expected_chapter: '87', difficulty: 'medium', notes: 'GIR 2a: mechanical assembly -> function (steering)' },
  { id: 'S5-AUTO-015', query: 'clutch plate friction disc for Mahindra pickup', source: 'session5-automotive', category: 'automotive', expected_routing: 'classify', expected_chapter: '87', difficulty: 'medium', notes: 'GIR 2a: friction material -> function (clutch)' },
  { id: 'S5-AUTO-016', query: 'drive shaft propeller shaft for truck', source: 'session5-automotive', category: 'automotive', expected_routing: 'classify', expected_chapter: '87', difficulty: 'medium', notes: 'GIR 2a: steel shaft -> function (transmission)' },
  { id: 'S5-AUTO-020', query: 'oil filter cartridge for petrol engine car', source: 'session5-automotive', category: 'automotive', expected_routing: 'classify', expected_chapter: '84', difficulty: 'hard', notes: 'Exception: Filters have specific heading 8421 in Ch.84' },
  { id: 'S5-AUTO-021', query: 'motorcycle tyre 120/80-17 tubeless radial', source: 'session5-automotive', category: 'automotive', expected_routing: 'classify', expected_chapter: '40', difficulty: 'easy', notes: 'Exception: Tyres have specific heading 4011 in Ch.40' },
  { id: 'S5-AUTO-022', query: 'alternator 12V 100A for car engine', source: 'session5-automotive', category: 'automotive', expected_routing: 'classify', expected_chapter: '85', difficulty: 'medium', notes: 'Electrical generators -> Ch.85 (specific heading 8511)' },
  { id: 'S5-AUTO-023', query: 'starter motor 12V for diesel truck', source: 'session5-automotive', category: 'automotive', expected_routing: 'classify', expected_chapter: '85', difficulty: 'medium', notes: 'Electric motors -> Ch.85 (specific heading 8511)' },
  ...
  { id: 'S5-AUTO-025', query: 'timing belt rubber reinforced for Honda engine', source: 'session5-automotive', category: 'automotive', expected_routing: 'classify', expected_chapter: '40', difficulty: 'medium', notes: 'Transmission belts have specific heading 4010 in Ch.40' },
];

// Session5 Simple unique cases (many overlap, include only truly unique ones)
const simpleSupplemental: EvalTestCase[] = [
  { id: 'S5-SIMP-002', query: 'fresh red apples Shimla variety', source: 'session5-simple', category: 'food_agri', expected_routing: 'classify', expected_chapter: '08', difficulty: 'easy', notes: 'Fresh fruit Ch.08' },
  { id: 'S5-SIMP-004', query: 'refined white cane sugar crystal', source: 'session5-simple', category: 'food_agri', expected_routing: 'classify', expected_chapter: '17', difficulty: 'easy', notes: 'Sugar Ch.17' },
  { id: 'S5-SIMP-005', query: 'wheat flour all purpose maida', source: 'session5-simple', category: 'food_agri', expected_routing: 'classify', expected_chapter: '11', difficulty: 'easy', notes: 'Flour from cereals Ch.11' },
  { id: 'S5-SIMP-009', query: 'fresh raw prawns shrimp frozen', source: 'session5-simple', category: 'food_agri', expected_routing: 'classify', expected_chapter: '03', difficulty: 'easy', notes: 'Crustaceans Ch.03' },
  { id: 'S5-SIMP-010', query: 'milk chocolate bar with almonds', source: 'session5-simple', category: 'food_agri', expected_routing: 'classify', expected_chapter: '18', difficulty: 'easy', notes: 'Chocolate products Ch.18' },
  { id: 'S5-SIMP-014', query: 'cotton bed sheet queen size white', source: 'session5-simple', category: 'textile', expected_routing: 'classify', expected_chapter: '63', difficulty: 'easy', notes: 'Bed linen Ch.63' },
  { id: 'S5-SIMP-015', query: 'bath towel cotton terry cloth blue', source: 'session5-simple', category: 'textile', expected_routing: 'classify', expected_chapter: '63', difficulty: 'easy', notes: 'Towels Ch.63' },
  { id: 'S5-SIMP-017', query: 'polyester curtains printed home decor', source: 'session5-simple', category: 'textile', expected_routing: 'classify', expected_chapter: '63', difficulty: 'easy', notes: 'Curtains Ch.63' },
  ...
  { id: 'S5-SIMP-021', query: 'LED television 55 inch smart TV 4K', source: 'session5-simple', category: 'electronics', expected_routing: 'classify', expected_chapter: '85', difficulty: 'easy', notes: 'Televisions Ch.85' },
  { id: 'S5-SIMP-022', query: 'double door refrigerator frost free 300L', source: 'session5-simple', category: 'electronics', expected_routing: 'classify', expected_chapter: '84', difficulty: 'easy', notes: 'Refrigerators Ch.84' },
  { id: 'S5-SIMP-023', query: 'front load washing machine automatic 7kg', source: 'session5-simple', category: 'electronics', expected_routing: 'classify', expected_chapter: '84', difficulty: 'easy', notes: 'Washing machines Ch.84' },
  { id: 'S5-SIMP-024', query: 'microwave oven convection 25 liter stainless', source: 'session5-simple', category: 'electronics', expected_routing: 'classify', expected_chapter: '85', difficulty: 'easy', notes: 'Microwave ovens Ch.85' },
  { id: 'S5-SIMP-025', query: 'split air conditioner 1.5 ton inverter', source: 'session5-simple', category: 'electronics', expected_routing: 'classify', expected_chapter: '84', difficulty: 'easy', notes: 'Air conditioners Ch.84' },
  { id: 'S5-SIMP-029', query: 'gold necklace 22 karat hallmarked jewelry', source: 'session5-simple', category: 'metal', expected_routing: 'classify', expected_chapter: '71', difficulty: 'easy', notes: 'Jewelry Ch.71' },
  { id: 'S5-SIMP-032', query: 'plastic bucket 20 liter with handle', source: 'session5-simple', category: 'chemical', expected_routing: 'classify', expected_chapter: '39', difficulty: 'easy', notes: 'Plastic household articles Ch.39' },
  { id: 'S5-SIMP-033', query: 'rubber gloves industrial heavy duty latex', source: 'session5-simple', category: 'chemical', expected_routing: 'classify', expected_chapter: '40', difficulty: 'easy', notes: 'Rubber articles Ch.40' },
  { id: 'S5-SIMP-034', query: 'polyethylene shopping bags carry bags', source: 'session5-simple', category: 'chemical', expected_routing: 'classify', expected_chapter: '39', difficulty: 'easy', notes: 'Plastic bags Ch.39' },
  ...
  { id: 'S5-SIMP-037', query: 'ballpoint pen blue ink plastic body', source: 'session5-simple', category: 'other', expected_routing: 'classify', expected_chapter: '96', difficulty: 'easy', notes: 'Writing instruments Ch.96' },
  { id: 'S5-SIMP-038', query: 'umbrella folding automatic rain protection', source: 'session5-simple', category: 'other', expected_routing: 'classify', expected_chapter: '66', difficulty: 'easy', notes: 'Umbrellas Ch.66' },
  { id: 'S5-SIMP-039', query: 'wristwatch quartz analog stainless steel', source: 'session5-simple', category: 'other', expected_routing: 'classify', expected_chapter: '91', difficulty: 'easy', notes: 'Watches Ch.91' },
  { id: 'S5-SIMP-040', query: 'acoustic guitar wooden 6 string classical', source: 'session5-simple', category: 'other', expected_routing: 'classify', expected_chapter: '92', difficulty: 'easy', notes: 'Musical instruments Ch.92' },
];
